...
name attribute tells the server the meaning of what the user has typed. So, if 
the user types in "Smith" as the last name, the name of the field - "lname" - 
will get to the server along with "Smith" so that the server knows the last 
name is Smith, not the first name.
